...
import com.tavakkolian.wtfwsf.util.SystemUiHider;
...
public class TicketChecker extends Activity {
	...
	private static final String WSFBaseURL = "https://secure4.gatewayticketing.com/WSDOT/account/TicketLookup.aspx?VisualID=";
	...
	private class GetBalanceTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			String url = WSFBaseURL+params[0];	// params[0] is the barcode
			...
			try {
				...
				// Log.d("doInBackground",doc.select("div#TicketLookup").toString());
				Elements e = doc.select(
						"div#TicketLookup > table:eq(0) tr:eq(7) td:eq(1)");
				if (e != null) {
